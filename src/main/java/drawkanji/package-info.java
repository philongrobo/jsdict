...
<p>
Load the data file into a {@link drawkanji.KanjiList} object:
</p>
...
<ul>
<li>Create a new (empty) {@link drawkanji.KanjiInfo} object.</li>
<li>For each stroke, create a new {@link drawkanji.InputStroke} object. You will need
...
<li>Add each {@link drawkanji.InputStroke} object using
{@link drawkanji.KanjiInfo#addStroke(InputStroke)}.</li>
<li>When all the strokes are added, call {@link drawkanji.KanjiInfo#finish()}; this scales
the input data and prepares data structures ready for matching.</li>
</ul>

<p>
You now have a finished {@link drawkanji.KanjiInfo} object representing the user's
drawing.
</p>
...
{@link drawkanji.KanjiList#getTopMatches(KanjiInfo, KanjiInfo.MatchAlgorithm)}
to obtain matches.
</p>
...
The
{@link drawkanji.KanjiList#getTopMatches(KanjiInfo, KanjiInfo.MatchAlgorithm)}
function returns a number of {@link drawkanji.KanjiMatch} objects, in order. Each
...
{@link drawkanji.StatsReporter#phoneHome(KanjiInfo, String, KanjiInfo.MatchAlgorithm, int, String, StatsReporter.Callback)}
